...
'''
bart = Student()
print(bart)     # <__main__.Student object at 0x000001BBEF2C2DA0>
print(Student)      # <class '__main__.Student'>
'''
可以看到，变量bart指向的就是一个Student的实例，
后面的0x000001BBEF2C2DA0是内存地址，每个object的地址都不一样，而Student本身则是一个类。

可以自由地给一个实例变量绑定属性，比如，给实例bart绑定一个name属性：
'''
bart.name = 'wang'
print(bart.name)    # wang
'''
...
wang = Student('wang',10)
print(lisa.name, lisa.get_grade())  # lisa A
print(wang.name, wang.get_grade())  # wang C
'''
小结
...
'''
bart1 = Student('bart1', 65)
print(bart1._Student__name)     # bart1
'''
...
它们run()的时候，显示的都是Animal is running...，符合逻辑的做法是分别显示Dog is running...和Cat is running...，因此，对Dog和Cat类改进如下：
'''
class Dog(Animal):
...
'''
print(dir(b))   # ['__class__', '__delattr__', '__dict__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'run']
'''
...
'''
# print(getattr(obj,'z'))
# 报错  AttributeError: 'MyObject' object has no attribute 'z'
