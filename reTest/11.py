...
Traceback (most recent call last):
  File "E:\pythonProject\Test\reTest\11.py", line 29, in <module>
    print(s2.set_age())
...
'''
Traceback (most recent call last):
  File "E:\pythonProject\Test\reTest\11.py", line 57, in <module>
    s.score = 66
...
又视为访问self的属性，于是又转换为方法调用，造成无限递归，
...
print(Student('wang'))  # Student object (name: wang)
'''
